...
- [Check the limit is real](~/.claude/memory/feedback_check_the_limit_is_real.md) — check it isn't already handled: evidence the system holds, a general rule whose premise fails here, or work a later step already owns

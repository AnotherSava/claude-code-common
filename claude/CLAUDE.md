...
- [Check the limit is real](~/.claude/memory/feedback_check_the_limit_is_real.md) — before settling for an honest "unverified" ladder, check the system doesn't already hold the evidence you said it lacked
